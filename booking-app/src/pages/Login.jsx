...
export default function Login() {
  ...
  // Fungsi Kirim Email Lupa Password via Supabase untuk Netlify
  const handleForgotPassword = async (e) => {
    ...
    try {
      // Mengirim email reset password dengan mengarah ke domain Netlify Anda secara otomatis
      ...
      setSuccessMsg("Instruksi pemulihan kata sandi telah dikirim ke email Anda. Silakan cek kotak masuk atau folder spam.");
      setResetEmail("");
    } catch (err) {
            ...
            <form onSubmit={handleForgotPassword} className="space-y-5">
              <div>
                ...
                <p className="text-xs text-slate-300 mt-2">
                  Kami akan mengirimkan tautan pemulihan sandi langsung ke email tersebut.
                </p>
              </div>
